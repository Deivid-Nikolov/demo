...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "ALTER TABLE owners DROP id;
            ALTER TABLE owners ADD id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST;";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            <?php
                                $linkk = mysqli_connect('localhost','root','','angelos_kursova')or die(mysqli_error());
                                $p_id = trim($_GET["id"]);
                                $user_query=mysqli_query($linkk,"select * from owners where id='$p_id'")or die(mysqli_error());
