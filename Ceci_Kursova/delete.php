...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "ALTER TABLE pilots DROP id;
            ALTER TABLE pilots ADD id INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY FIRST;";
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger">
                            ...
                            ?>
                            <p>Сигурни ли сте, че искате да изтриете проект: <b><?php echo $row["first_name"]; ?></b>?</p>
                            <?php } ?>
                            <p>
